...
LiveAreaWidget::LiveAreaWidget(EmuEnvState &emuenv, const std::string &app_path, QWidget *parent)
    : QWidget(parent)
    , m_emuenv(emuenv)
    , m_app_path(app_path) {
    ...
    connect(m_gate_anim, &QVariantAnimation::finished, this, [this]() {
...
void LiveAreaWidget::paintEvent(QPaintEvent *) {
    QPainter p(this);
