...
GameListContextMenu::GamePaths GameListContextMenu::make_game_paths(const app::Game &game) const {
    const auto &title_id = game.title_id;
    return {
        .app = m_emuenv.pref_path / "ux0/app" / game.path,
        .save_data = m_emuenv.pref_path / "ux0/user" / m_emuenv.io.user_id / "savedata" / game.savedata,
        .patch = m_emuenv.shared_path / "patch" / title_id,
        .addcont = m_emuenv.pref_path / "ux0/addcont" / game.addcont,
...
void GameListContextMenu::add_boot_actions(const app::Game &game) {
    ...
    connect(view_live_area, &QAction::triggered, this, [this, &game] {
        emit view_live_area_requested(game);
    });
}
...
void GameListContextMenu::add_misc_actions(const app::Game &game) {
    ...
    connect(decrypt, &QAction::triggered, this, [this, &game, title_id] {
