...
void main() {
    ...
    if (use_gloss) {
        ...
        float u = tc0.x;
        float v = 1.0 - tc0.y; // GL vertex Y-flip inverts tc0.y; restore top-down for gloss
    ...
    if (use_btn_gloss) {
        float u = tc0.x;
        float v = 1.0 - tc0.y; // GL vertex Y-flip inverts tc0.y; restore top-down for btn_gloss
