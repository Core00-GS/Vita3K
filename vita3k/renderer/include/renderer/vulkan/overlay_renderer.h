...
private:
    ...
    vk::DescriptorPool m_desc_pools[MAX_FRAMES_IN_FLIGHT] = {};
    ...
    vkutil::Buffer m_vertex_buffers[MAX_FRAMES_IN_FLIGHT] = {};
    vk::DeviceSize m_vertex_buffer_offset = 0;

    std::vector<vkutil::Buffer> m_staging_garbage[MAX_FRAMES_IN_FLIGHT];
